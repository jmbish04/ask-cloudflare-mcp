/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9c8b414e3773d1a9ed2faba9759b8232)
// Runtime types generated with workerd@1.20251202.0 2024-11-30 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RepoAnalyzerContainerConfig" | "Sandbox" | "ChatAgent";
	}
	interface Env {
		...
		REPO_ANALYZER_CONTAINER: DurableObjectNamespace<import("./src/index").RepoAnalyzerContainerConfig>;
		...
		ENGINEER_WORKFLOW: Workflow<Parameters<import("./src/index").EngineerWorkflow['run']>[0]['payload']>;
		GOVERNANCE_WORKFLOW: Workflow<Parameters<import("./src/index").GovernanceWorkflow['run']>[0]['payload']>;
		INGESTION_WORKFLOW: Workflow<Parameters<import("./src/index").IngestionWorkflow['run']>[0]['payload']>;
		MAINTENANCE_WORKFLOW: Workflow<Parameters<import("./src/index").MaintenanceWorkflow['run']>[0]['payload']>;
	}
}
